...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yangcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yangcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yangcoin transaction") + "\n" +
              "  yangcoin-tx [options] -create [commands]   " + _("Create hex-encoded yangcoin transaction") + "\n" +
              "\n";
