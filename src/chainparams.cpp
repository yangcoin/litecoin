...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    printf("%s %s\n", 
        pszTimestamp,txNew.GetHash().ToString().c_str() );
    CBlock genesis;
    genesis.nTime    = nTime;
    genesis.nBits    = nBits;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan =  1 * 1 * 60 * 60; // 3.5 days
        ...
        // consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000003d54a2f2bb");
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000000509817ea9e");
        ...
        consensus.defaultAssumeValid = uint256S("0xc9092e71ba584b6defc8403a9ca9dc9740b445ee76d62ecd3a3d17d368609946");//111111
        ...
        if(hashGenesis !=genesis.GetHash()){
            genesis.nNonce = 0;
            printf("start Mainnet search!!!\n");
             printf("genesis = %s (defined = %s)\n", hashGenesis.ToString().c_str(), genesis.GetHash().ToString().c_str());
        ...
        vSeeds.emplace_back("seed-yng.bitchk.com", true);
        ...
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,140);
        ...
        fMineBlocksOnDemand = false;
         ...
         checkpointData = (CCheckpointData) {
            { 
                ...
                {  111111, uint256S("0xc9092e71ba584b6defc8403a9ca9dc9740b445ee76d62ecd3a3d17d368609946")}
            }
        };
