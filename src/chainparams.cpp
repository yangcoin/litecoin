...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("c1", "seed.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed1", "yng001.bitchk.com",true));
        vSeeds.push_back(CDNSSeedData("seed2", "seed-yng.bitchk.com",true));
