...
Output from `gbuild` will look something like
    ...
    From https://github.com/yangcoin/yangcoin
...
[yangcoin-project/gitian.sigs.ltc](https://github.com/yangcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
